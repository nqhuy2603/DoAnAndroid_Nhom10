...
public class MyThuatActivity extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_thuat);
    ...
    private void AnhXa() {
        toolbar = findViewById(R.id.toolbarMyThuat);
        recyclerView = findViewById(R.id.recyclerviewMyThuat);
